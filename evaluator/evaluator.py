...
def getAEP(turb_rad, turb_coords, power_curve, wind_inst_freq, 
    ...
    assert n_turbs ==  50, "[ERR] Number of turbines is not 50."
...
if __name__ == "__main__":
    ...
    turb_coords   =  getTurbLoc(r'./../test_locations.csv')
    ...
    wind_inst_freq =  binWindResourceData('./wind_data/wind_data_2015.csv')   
